	          ...
	          <div class="box box-default collapsed-box">
	          	<div class="box-header with-border">
	          		<ul style="padding: 0px;list-style-type: none;">
	          			<li style="float:left;">
	          				<div><input type="text" value="Amsterdam,Washington,Sydney,Beijing,Cairo" data-role="tagsinput" placeholder="Add tags"></div>
		              	</li>
		              	<li style="float:left;margin-left: 5px;">
		              		<div><button class="btn btn-block btn-default">Search</button></div>
		              	</li>
	              	</ul>
            ...
            <!-- Search Result Start -->
             ...
             <div class="tab-pane active" id="project">
              ...
              <tr>
                ...
                <td><a href="#" class="btn btn-default btn-sm"><i class="fa fa-share"></i> share(10)</a></td>
              </tr>
              <tr>
                <td>219</td>
                <td>Bacon ipsum dolor sit amet salami venison chicken flank fatback doner.</td>
                ...
                <td><a href="#" class="btn btn-default btn-sm"><i class="fa fa-share"></i></a></td>
              </tr>
              <tr>
                <td>657</td>
                <td>Bacon ipsum dolor sit amet salami venison chicken flank fatback doner.</td>
